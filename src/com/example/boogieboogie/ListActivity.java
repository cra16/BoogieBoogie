...
/**
 * This fragment is for the first tab (List all books that the user has) All
 * books will be shown as Gridview using GridImgeAdapter class which extends
 * BaseAdapter
 * 
 * 
 */
public class ListActivity extends Fragment implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		for (int i = 0; i < numOfItems; i++) {
			arrayList.add(new BookData(c_title.getString(0), c_image
					.getString(0), c_author.getString(0), c_memo.getString(0)));
		...
		gv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View v,
				...
				// TODO Auto-generated method stub
				// Toast.makeText(view.getContext(), "OK",
	...
	public Cursor selectColumn(SQLiteDatabase db, String col_name,
			String table_name) {
